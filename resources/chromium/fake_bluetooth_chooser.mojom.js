...
(function() {
  ...
  function FakeBluetoothChooser_SetBluetoothManualChooser_Params(values) {
    this.initDefaults_();
    this.initFields_(values);
  }


  FakeBluetoothChooser_SetBluetoothManualChooser_Params.prototype.initDefaults_ = function() {
    this.enable = false;
  };
  FakeBluetoothChooser_SetBluetoothManualChooser_Params.prototype.initFields_ = function(fields) {
    for(var field in fields) {
        if (this.hasOwnProperty(field))
          this[field] = fields[field];
    }
  ...
  FakeBluetoothChooser_SetBluetoothManualChooser_Params.validate = function(messageValidator, offset) {
    var err;
    err = messageValidator.validateStructHeader(offset, codec.kStructHeaderSize);
    if (err !== validator.validationError.NONE)
        return err;
  ...
  FakeBluetoothChooser_SetBluetoothManualChooser_Params.encodedSize = codec.kStructHeaderSize + 8;

  FakeBluetoothChooser_SetBluetoothManualChooser_Params.decode = function(decoder) {
    var packed;
    var val = new FakeBluetoothChooser_SetBluetoothManualChooser_Params();
    var numberOfBytes = decoder.readUint32();
    var version = decoder.readUint32();
  ...
  FakeBluetoothChooser_SetBluetoothManualChooser_Params.encode = function(encoder, val) {
    var packed;
    encoder.writeUint32(FakeBluetoothChooser_SetBluetoothManualChooser_Params.encodedSize);
    encoder.writeUint32(0);
    packed = 0;
  ...
  function FakeBluetoothChooser_SetBluetoothManualChooser_ResponseParams(values) {
    this.initDefaults_();
    this.initFields_(values);
  }


  FakeBluetoothChooser_SetBluetoothManualChooser_ResponseParams.prototype.initDefaults_ = function() {
  };
  FakeBluetoothChooser_SetBluetoothManualChooser_ResponseParams.prototype.initFields_ = function(fields) {
    for(var field in fields) {
        if (this.hasOwnProperty(field))
          this[field] = fields[field];
    }
  ...
  FakeBluetoothChooser_SetBluetoothManualChooser_ResponseParams.validate = function(messageValidator, offset) {
    var err;
    err = messageValidator.validateStructHeader(offset, codec.kStructHeaderSize);
    if (err !== validator.validationError.NONE)
        return err;
  ...
  FakeBluetoothChooser_SetBluetoothManualChooser_ResponseParams.encodedSize = codec.kStructHeaderSize + 0;

  FakeBluetoothChooser_SetBluetoothManualChooser_ResponseParams.decode = function(decoder) {
    var packed;
    var val = new FakeBluetoothChooser_SetBluetoothManualChooser_ResponseParams();
    var numberOfBytes = decoder.readUint32();
    var version = decoder.readUint32();
    return val;
  };

  FakeBluetoothChooser_SetBluetoothManualChooser_ResponseParams.encode = function(encoder, val) {
    var packed;
    encoder.writeUint32(FakeBluetoothChooser_SetBluetoothManualChooser_ResponseParams.encodedSize);
    encoder.writeUint32(0);
  };
  ...
  var kFakeBluetoothChooser_SetBluetoothManualChooser_Name = 1894054557;
  var kFakeBluetoothChooser_WaitForEvents_Name = 1329953586;
  var kFakeBluetoothChooser_SelectPeripheral_Name = 813355832;
  var kFakeBluetoothChooser_Cancel_Name = 1167358351;
  var kFakeBluetoothChooser_Rescan_Name = 914133614;
  ...
  FakeBluetoothChooserPtr.prototype.setBluetoothManualChooser = function() {
    return FakeBluetoothChooserProxy.prototype.setBluetoothManualChooser
        .apply(this.ptr.getProxy(), arguments);
  };

  FakeBluetoothChooserProxy.prototype.setBluetoothManualChooser = function(enable) {
    var params = new FakeBluetoothChooser_SetBluetoothManualChooser_Params();
    params.enable = enable;
    return new Promise(function(resolve, reject) {
      var builder = new codec.MessageV1Builder(
          kFakeBluetoothChooser_SetBluetoothManualChooser_Name,
          codec.align(FakeBluetoothChooser_SetBluetoothManualChooser_Params.encodedSize),
          codec.kMessageExpectsResponse, 0);
      builder.encodeStruct(FakeBluetoothChooser_SetBluetoothManualChooser_Params, params);
      var message = builder.finish();
      this.receiver_.acceptAndExpectResponse(message).then(function(message) {
        var reader = new codec.MessageReader(message);
        var responseParams =
            reader.decodeStruct(FakeBluetoothChooser_SetBluetoothManualChooser_ResponseParams);
  ...
  FakeBluetoothChooserStub.prototype.setBluetoothManualChooser = function(enable) {
  ...
  FakeBluetoothChooserStub.prototype.acceptWithResponder =
    ...
    var reader = new codec.MessageReader(message);
    switch (reader.messageName) {
    case kFakeBluetoothChooser_SetBluetoothManualChooser_Name:
      var params = reader.decodeStruct(FakeBluetoothChooser_SetBluetoothManualChooser_Params);
      this.setBluetoothManualChooser(params.enable).then(function(response) {
        var responseParams =
            new FakeBluetoothChooser_SetBluetoothManualChooser_ResponseParams();
        var builder = new codec.MessageV1Builder(
            kFakeBluetoothChooser_SetBluetoothManualChooser_Name,
            codec.align(FakeBluetoothChooser_SetBluetoothManualChooser_ResponseParams.encodedSize),
            codec.kMessageIsResponse, reader.requestID);
        builder.encodeStruct(FakeBluetoothChooser_SetBluetoothManualChooser_ResponseParams,
                             responseParams);
        var message = builder.finish();
    ...
    switch (message.getName()) {
      case kFakeBluetoothChooser_SetBluetoothManualChooser_Name:
        if (message.expectsResponse())
          paramsClass = FakeBluetoothChooser_SetBluetoothManualChooser_Params;
      break;
      case kFakeBluetoothChooser_WaitForEvents_Name:
        if (message.expectsResponse())
   ...
   switch (message.getName()) {
      case kFakeBluetoothChooser_SetBluetoothManualChooser_Name:
        if (message.isResponse())
          paramsClass = FakeBluetoothChooser_SetBluetoothManualChooser_ResponseParams;
        break;
      case kFakeBluetoothChooser_WaitForEvents_Name:
        if (message.isResponse())
